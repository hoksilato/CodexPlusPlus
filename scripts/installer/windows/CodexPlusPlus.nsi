...
Section "Install"
  ...
  Delete "$DESKTOP\Trình Quản Lý Codex++.lnk"
  Delete "$SMPROGRAMS\Codex++\Trình Quản Lý Codex++.lnk"

  CreateShortcut "$DESKTOP\Codex++.lnk" "$INSTDIR\codex-plus-plus.exe" "" "$INSTDIR\codex-plus-plus.exe"
  CreateShortcut "$DESKTOP\Trình Quản Lý Codex++.lnk" "$INSTDIR\codex-plus-plus-manager.exe" "" "$INSTDIR\codex-plus-plus-manager.exe"
  ...
  CreateShortcut "$SMPROGRAMS\Codex++\Trình Quản Lý Codex++.lnk" "$INSTDIR\codex-plus-plus-manager.exe" "" "$INSTDIR\codex-plus-plus-manager.exe"
  CreateShortcut "$SMPROGRAMS\Codex++\Gỡ Cài Đặt Codex++.lnk" "$INSTDIR\uninstall.exe" "" "$INSTDIR\codex-plus-plus-manager.exe"
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\Codex++\Trình Quản Lý Codex++.lnk"
  Delete "$SMPROGRAMS\Codex++\Gỡ Cài Đặt Codex++.lnk"
